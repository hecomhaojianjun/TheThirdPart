...
- (void)setup
{
    ...
    // add by wangfei[2015-04-14]
    // 下方添加分隔线
    self.spliteLine = [[UIView alloc] init];
    self.spliteLine.backgroundColor = [UIColor colorWithRed:(0xdd / 255.0f) green:(0xdd / 255.0f) blue:(0xdd / 255.0f) alpha:1.0f];
    [self.contentView addSubview:self.spliteLine];
    // end add
    
    self.cancelButton = [UIButton buttonWithType:UIButtonTypeCustom];
    [self.cancelButton setTitle:@"取消" forState:UIControlStateNormal];
    self.cancelButton.titleLabel.font = [UIFont boldSystemFontOfSize:15.0f];
    ...
    self.spliteLine.translatesAutoresizingMaskIntoConstraints = NO;
...
- (void)updateConstraints
{
    ...
    NSArray *constraints = nil;
    NSLayoutConstraint *constraint = nil;
    NSDictionary *views = @{@"contentView": self.contentView, @"closeButton": self.closeButton, @"titleLabel": self.titleLabel, @"spliteLine": self.spliteLine, @"cancelButton": self.cancelButton, @"iconView": self.iconView, @"view": self, @"referView": self.referView};
    ...
    // add by wangfei[2015-04-14]
    // spliteLine跟contentView左右挨着
    constraints = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|[spliteLine]|" options:0 metrics:nil views:views];
    [self.contentView addConstraints:constraints];
    // end add
    ...
    constraints = [NSLayoutConstraint constraintsWithVisualFormat:@"V:|-8-[titleLabel(==30)]-[iconView]-20-[spliteLine(==1)]-[cancelButton(==30)]-8-|" options:0 metrics:nil views:views];
    [self.contentView addConstraints:constraints];
